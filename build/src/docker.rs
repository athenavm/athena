...
/// Uses ATHENA_DOCKER_IMAGE environment variable if set, otherwise constructs the image to use based
/// on the provided tag.
...
pub fn create_docker_command(
    ...
    let mut docker_args = vec![
        ...
        program_dir_path,
        "-e".to_string(),
        "RUSTUP_TOOLCHAIN=athena".to_string(),
        "-e".to_string(),
    ...
    // Add the program build arguments.
